...
main() {
  ...
  # messages
  set message-style "fg=${thm_fg},bg=${thm_black4},align=centre"
  set message-command-style "fg=${thm_fg},bg=${thm_black4},align=centre"
  ...
  setw mode-style "fg=${thm_black} bg=${thm_green} bold"
